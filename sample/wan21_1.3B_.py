...
for i in range(12):
    ...
    save_video(video, f"output/aimier_1frame_1.3B2_{i}.mp4", fps=15, quality=5)
    prev_frames = video
save_video(videos, f"output/aimier_1frame_1.3B2_all.mp4", fps=15, quality=5)