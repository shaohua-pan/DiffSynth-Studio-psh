...
class WanVideoPipeline(BasePipeline):
    ...
    def __call__(
        ...
        next_frames: Optional[list[Image.Image]] = None,
        # Video-to-video
...
class WanVideoUnit_ImageEmbedderVAE(PipelineUnit):
    def __init__(self):
        super().__init__(
            input_params=("input_image", "end_image", "num_frames", "height", "width", "tiled", "tile_size", "tile_stride", "prev_frames", "next_frames"),
            onload_model_names=("vae",)
        )

    def process(self, pipe: WanVideoPipeline, input_image, end_image, num_frames, height, width, tiled, tile_size, tile_stride, prev_frames, next_frames):
