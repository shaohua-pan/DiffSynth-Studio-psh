...
class WanModel(torch.nn.Module):
    ...
    def forward(self,
        ...
        if latent_indices_all is not None:
            ...
            freqs_f = torch.cat([self.freqs[0][clean_latent_indices_pre], self.freqs[0][latent_indices], self.freqs[0][clean_latent_indices_post],
                                self.freqs[0][clean_latent_2x_indices], self.freqs[0][clean_latent_4x_indices]], dim=0)
            freqs = torch.cat([
